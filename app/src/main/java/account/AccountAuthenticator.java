...
import com.toquescript.norcexapp.Login;
...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
	...
	public Bundle addAccount(AccountAuthenticatorResponse response,
		...
		it.putExtra(Constants.ARG_ACCOUNT_TYPE, accountType);
		it.putExtra(Constants.ARG_AUTH_TYPE, authTokenType != null ? authTokenType : Constants.ACCOUNT_TOKEN_TYPE);
	...
	public Bundle getAuthToken(AccountAuthenticatorResponse response,
		...
		Intent it = new Intent(mContext, Login.class);
		it.putExtra(Constants.ARG_ACCOUNT_TYPE, account.type);
		it.putExtra(Constants.ARG_ACCOUNT_NAME, account.name);
		it.putExtra(Constants.ARG_AUTH_TYPE, authTokenType);
		it.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
	...
	public String getAuthTokenLabel(String authTokenType) {
		...
		if(authTokenType.equals(Constants.ACCOUNT_TOKEN_TYPE)){
			return("Acesso completo a aplica��o");
		}
		return null;
	}
